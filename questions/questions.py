questions = {
    "1": "Q1: How much do neighbourhoods affect the price of AirBnbs?",
    ...
    "3": "Q3: Which features of the dataset have the best predictive power for the price of a property based on linear regression?",
    "4": "Q4 : What are the features that best predict superhost status?",
}
